...
import { DollarSign, Smartphone, TimerIcon, } from "lucide-react";
  ...
  const formatar = (valor: number) =>
    ...
    return(
        <section className="flex flex-col  w-full min-h-screen">
                     <header className="border-b p-5 py-7 justify-between border-purple-200 h-12 w-full flex items-center ">
